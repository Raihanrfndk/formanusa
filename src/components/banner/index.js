...
const HeroSection = () => {
  return (
    ...
    >
        ...
        <div className="grid grid-cols-3 items-start gap-6">
          ...
          <div className="flex flex-col items-center text-left">
            ...
            <p className="text-xs font-bold">
              Bina Nusantara University | School of Information System | Business
              Analytics | Jakarta Barat, Kemanggisan
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-left">
            ...
            />
            <p className="text-xs font-bold">
              SDG 11: Sustainable Cities and Communities | SDG 8: Decent Work and
      ...
      {/* Bottom banner image */}
      <div className="w-full h-auto py-2 px-3 bg-cover bg-center flex flex-col justify-center items-end" style={{ backgroundImage: "url('/bottom-banner.png')" }}>
